...
# ### testing suite - tsest model output
...
# def GS_test(test_fit, dsub, dSiOx, lw=1, ll=220, w1w=5, w2w=3, return_bolotest=False):
...
#         if return_bolotest:   # return output from G_bolotest
#             GS0  = G_bolotest(test_fit, anopts,  bolo0, layer='S')[0]/4
#             GSI  = G_bolotest(test_fit, anoptsI, boloI, layer='S')[0]/4
#             GSN  = G_bolotest(test_fit, anoptsN, boloN, layer='S')[0]/4
#         else:   # return output from G_leg
#             GS0  = G_leg(test_fit, anopts,  bolo0, dsub, 0, 0, 0, 0, True, False, False, legA=True)
#             GSI  = G_leg(test_fit, anoptsI, boloI, dsub, 0, 0, 0, 0, True, False, False, legA=True)
#             GSN  = G_leg(test_fit, anoptsN, boloN, dsub, 0, 0, 0, 0, True, False, False, legA=True)


#         return GS0, GSI, GSN

# def test_alphascaleS(return_bolotest=False, verbose=False):
...
#         GSleg0_a0_1, GSlegI_a0_1, GSlegN_a0_1 = GS_test(fit_a0, dsub1, dSiOx1, lw=lw, w1w=w1w, w2w=w2w, return_bolotest=return_bolotest)
#         if verbose:
#             # print('all alpha    = 0: GS_0 = {}; GS_I = {}; GS_N = {}'.format(round(GSleg0_a0_1, 1), round(GSlegI_a0_1, 1), round(GSlegN_a0_1, 1)))
#             print('\n'); print('all alpha    = 0:')
#             print('GS0  / GSN   = {}'.format(GSleg0_a0_1/GSlegN_a0_1))
#             print('dsub / dSiOx = {}'.format(dsub1/dSiOx1)); print('\n')
#         assert GSleg0_a0_1/GSlegN_a0_1 == dsub1/dSiOx1, "GS_0/GS_N != dsub/dSiOx"

#         GSleg0_aS1_1, GSlegI_aS1_1, GSlegN_aS1_1 = GS_test(fit_aS1, dsub1, dSiOx1, lw=lw, w1w=w1w, w2w=w2w, return_bolotest=return_bolotest)
#         if verbose:
#             # print('alphaS           = 1: GS_0 = {}; GS_I = {}; GS_N = {}'.format(round(GSleg0_aS1_1, 1), round(GSlegI_aS1_1, 1), round(GSlegN_aS1_1, 1)))
#             print('alphaS           = 1:')
#             print('GS0   / GSN      = {}'.format(GSleg0_aS1_1/GSlegN_aS1_1))
#             print('(dsub / dSiOx)^2 = {}'.format((dsub1/dSiOx1)**2)); print('\n')
#         assert GSleg0_aS1_1/GSlegN_aS1_1 == (dsub1/dSiOx1)**2, "GS_0/GS_N != (dsub/dSiOx)^2"

#         GSleg0_aI1_1, GSlegI_aI1_1, GSlegN_aI1_1 = GS_test(fit_aI1, dsub1, dSiOx1, lw=lw, w1w=w1w, w2w=w2w, return_bolotest=return_bolotest)
#         if verbose:
#             # print('alphaI         = 1: GS_0 = {}; GS_I = {}; GS_N = {}'.format(round(GSleg0_aI1_1, 1), round(GSlegI_aI1_1, 1), round(GSlegN_aI1_1, 1)))
#             print('alphaI         = 1:')
#             print('GS0   / GSN    = {}'.format(GSleg0_aI1_1/GSlegN_aI1_1))
#             print('(dsub / dSiOx) = {}'.format(dsub1/dSiOx1)); print('\n')
#         assert GSleg0_aI1_1/GSlegN_aI1_1 == dsub1/dSiOx1, "GS_0/GS_N != dsub/dSiOx"
